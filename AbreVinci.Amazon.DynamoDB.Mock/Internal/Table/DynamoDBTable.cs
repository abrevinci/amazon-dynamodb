...
using AbreVinci.Amazon.DynamoDB.Mock.Internal.Table.Index;
...
namespace AbreVinci.Amazon.DynamoDB.Mock.Internal.Table
{
    internal class DynamoDBTable : IMockDynamoDBTable
    {
        ...
        public IEnumerable<DynamoDBMap> Items { get; }
        
        public IMockDynamoDBTable AddItem(DynamoDBMap item, bool availableForNonConsistentRead = true)
        {
            throw new System.NotImplementedException();
        }

        public IMockDynamoDBTable AddItems(IEnumerable<DynamoDBMap> items, bool availableForNonConsistentRead = true)
        {
            throw new System.NotImplementedException();
        }
    }
