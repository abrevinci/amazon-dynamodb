...
namespace AbreVinci.Amazon.DynamoDB.UnitTests.Table.DynamoDBTableTests.UseConsistentRead.IncludeAttributes
{
    public class GetAsync
    {
        ...
        [Fact]
        public async Task ShouldSetProjectionAttributesAndUseConsistentRead()
        {
            // Arrange
            ...
            // Act
            await _table.UseConsistentRead().IncludeAttributes("id", "value1").GetAsync(1);
